...
describe('Sliding Window', () => {
  ...
  describe('right', () => {
    ...
    it('should wrap multiple times if necessary', () => {
      let window = windowSlider([1, 2, 3], { windowSize: 9 });
  ...
  describe('reset', () => {
    ...
    it('should reset to the provided start index', () => {
      const window = windowSlider([1, 2, 3, 4], { startIndex: 2 });
      const originalWindow = window.current();
  ...
  describe('array', () => {
    ...
    it('should return a copy of the original array', () => {
      ...
      const window = windowSlider(originalArray);
